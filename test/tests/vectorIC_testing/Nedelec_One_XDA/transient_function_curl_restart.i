# This file uses the Exodus file from transient_function_curl.i for mesh and 
...
[Mesh]
  [geo]
    ...
    # file = 'transient_function_curl_out_at_10steps.e'
    # use_for_exodus_restart = true
    type = FileMeshGenerator
    file = 'transient_function_curl_out_at_10steps_0010_mesh.xda'
  []
[]
...
[UserObjects]
  [soln]
    ...
    mesh = 'transient_function_curl_out_at_10steps_0010_mesh.xda'
    es = 'transient_function_curl_out_at_10steps_0010.xda'
    system_variables = 'u'
    timestep = 'LATEST'
  []
[]
