 ...
 *  formulation
 */
class ElectromagneticMaterial : public ADMaterial
{
public:
  static InputParameters validParams();

  ElectromagneticMaterial(const InputParameters & parameters);
...
protected:
  ...
  /// The formulation the EM residuals (either STANDARD or HARMONIC)
